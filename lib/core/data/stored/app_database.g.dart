    ...
    if (data.containsKey('timer_duration_in_seconds')) {
      context.handle(
        ...
        timerDurationInSeconds.isAcceptableOrUnknown(
          data['timer_duration_in_seconds']!,
          _timerDurationInSecondsMeta,
        ),
      );
    } else if (isInserting) {
...
class StoredGame extends DataClass implements Insertable<StoredGame> {
  ...
  factory StoredGame.fromJson(
    ...
    return StoredGame(
      ...
      timerDurationInSeconds: serializer.fromJson<int>(
        json['timerDurationInSeconds'],
      ),
...
class StoredGamesCompanion extends UpdateCompanion<StoredGame> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (timerDurationInSeconds.present) {
      map['timer_duration_in_seconds'] = Variable<int>(
        timerDurationInSeconds.value,
      );
    }
...
class $StoredPlayersTable extends StoredPlayers
  ...
  StoredPlayer map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return StoredPlayer(
      ...
      scores: $StoredPlayersTable.$converterscores.fromSql(
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['name'] = Variable<String>(name);
    {
      map['scores'] = Variable<String>(
        $StoredPlayersTable.$converterscores.toSql(scores),
      );
    }
    return map;
  }
...
typedef $$StoredGamesTableCreateCompanionBuilder =
    StoredGamesCompanion Function({
      Value<int> id,
      required int timerDurationInSeconds,
      Value<bool> isFinished,
      required DateTime createdAt,
    });
typedef $$StoredGamesTableUpdateCompanionBuilder =
    StoredGamesCompanion Function({
      Value<int> id,
      Value<int> timerDurationInSeconds,
      Value<bool> isFinished,
...
final class $$StoredGamesTableReferences
  ...
  _storedPlayersRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.storedPlayers,
    aliasName: $_aliasNameGenerator(db.storedGames.id, db.storedPlayers.gameId),
  );

  $$StoredPlayersTableProcessedTableManager get storedPlayersRefs {
    final manager = $$StoredPlayersTableTableManager(
      $_db,
      $_db.storedPlayers,
...
class $$StoredGamesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $StoredGamesTable,
...
typedef $$StoredGamesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool storedPlayersRefs})
    >;
typedef $$StoredPlayersTableCreateCompanionBuilder =
    StoredPlayersCompanion Function({
      Value<int> id,
      required int gameId,
      required String name,
      required List<int> scores,
    });
typedef $$StoredPlayersTableUpdateCompanionBuilder =
    StoredPlayersCompanion Function({
      Value<int> id,
      Value<int> gameId,
      Value<String> name,
...
final class $$StoredPlayersTableReferences
  ...
  $$StoredGamesTableProcessedTableManager get gameId {
    ...
    final manager = $$StoredGamesTableTableManager(
      $_db,
      $_db.storedGames,
...
class $$StoredPlayersTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $StoredPlayersTable,
                    ...
                    if (gameId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$StoredPlayersTableReferences
                                    ._gameIdTable(db),
                                referencedColumn: $$StoredPlayersTableReferences
                                    ._gameIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$StoredPlayersTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $StoredPlayersTable,
      StoredPlayer,
